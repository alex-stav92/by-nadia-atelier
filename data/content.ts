...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    description:
      'Присылаете модель, фото, эскиз или просто описываете, что хотите получить.',
  },
  {
    num: '02',
    title: 'Обсуждаем детали',
    description:
      'Уточняем материалы, количество, сроки и особенности изделия. Согласовываем стоимость.',
  },
  {
    num: '03',
    title: 'Делаем образец',
    description:
      'Если он нужен, сначала отшиваем образец и согласовываем результат перед запуском партии.',
  },
  {
    num: '04',
    title: 'Запускаем производство',
    description:
      'После согласования готовим материалы и запускаем пошив нужного количества изделий.',
  },
  {
    num: '05',
    title: 'Проверяем качество',
    description:
      'Контролируем пошив и проверяем готовые изделия перед передачей.',
  },
  {
    num: '06',
    title: 'Передаём готовую партию',
    description:
      'Упаковываем заказ и передаём готовые изделия вам.',
  },
];
