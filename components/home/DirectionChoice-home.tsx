        ...
        <div className="grid gap-5 lg:grid-cols-2 lg:gap-6">
          ...
          >
            <div className="absolute inset-0">
              <img
                src={atelierImage}
                alt="Ателье — ремонт, подгонка и индивидуальный пошив одежды"
            ...
            <div className="relative p-8 sm:p-10">
              ...
              <p className="mt-4 max-w-sm text-sm leading-relaxed text-sand-200">
                Ремонт, подгонка и индивидуальный пошив одежды.
                <br />
                От небольшой починки до вещи с нуля — под вашу задачу и ваши мерки.
              </p>
          ...
          >
            <div className="absolute inset-0">
              <img
                src={productionImage}
                alt="Швейное производство одежды для брендов и компаний"
            ...
            <div className="relative p-8 sm:p-10">
              ...
              <p className="mt-4 max-w-sm text-sm leading-relaxed text-sand-200">
                Пошив одежды и небольших партий для брендов и компаний.
                <br />
                Работаем по образцу, ТЗ или готовым лекалам — от первого образца до партии.
              </p>
