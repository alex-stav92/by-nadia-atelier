...
<a href="#top" className="flex h-full items-center">
  ...
  />
        ...
        <div className="flex items-center gap-2">
          <CtaButton href="#contacts" className="hidden sm:inline-flex">
            Обсудить заказ
          </CtaButton>
          <button
            type="button"
      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            <span className="font-serif text-lg tracking-[0.22em]">BY NADIA</span>
            <button
              type="button"
              onClick={() => setOpen(false)}
          ...
          <nav className="mt-10 flex flex-col gap-1" aria-label="Мобильная навигация">
          ...
          <CtaButton href="#contacts" size="lg" variant="accent" onClick={() => setOpen(false)} className="mt-auto w-full">
            Обсудить заказ
          </CtaButton>
        </div>
      </div>
